<template lang='pug'>
  v-dialog(v-model='dialog', persistent='', fullscreen=true)
    div(style='height: 100%; width: 100%; background-color: black; opacity: 0.8; padding-top: 15%;')
        #floatingCirclesG
        ...
        div
          h2(style='color: #215a88; text-align: center;') Cargando
</template>
...
<style>
  ...
  @keyframes f_fadeG{
    0%{
      background-color:rgba(34,139,223,0.97);
    }
